...
router.route("/").post(middlewares_1.Auth, middlewares_1.UserIsAdmin, typeservice_1.addTypeService);
router.route("/").get(middlewares_1.Auth, middlewares_1.UserIsAdmin, typeservice_1.all);
