...
exports.deleteBrand = exports.updateBrand = exports.active = exports.all = exports.addBrand = void 0;
...
function addBrand(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const savedBrand = yield server_1.prisma.brand.create({ data: validation.data });
...
function all(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const all = yield server_1.prisma.brand.findMany();
...
function active(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const active = yield server_1.prisma.brand.findMany({ where: { featured: true } });
...
function updateBrand(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (!validation.success)
                return res.status(400).send({ status: 400, error: true, message: (0, zod_validation_error_1.fromZodError)(validation.error).message, data: {} });
            const savedBrand = yield server_1.prisma.brand.update({ where: { id: id, }, data: validation.data, });
            return res.status(200).send({ status: 200, error: false, message: "ok", data: savedBrand });
        }
        catch (err) {
            return res.status(500).send({ status: 500, error: true, message: "Une erreur s'est produite", data: {} });
...
function deleteBrand(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            let id = req.params.id;
            const brand = yield server_1.prisma.brand.delete({ where: { id: id } });
