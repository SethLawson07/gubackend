...
exports.all = exports.addOrderService = void 0;
const zod_1 = require("zod");
const zod_validation_error_1 = require("zod-validation-error");
const server_1 = require("../../server");
function addOrderService(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const savedOrderService = yield server_1.prisma.orderService.create({ data: validation.data });
...
function all(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const all = yield server_1.prisma.orderService.findMany({ orderBy: { createdat: 'desc' } });
