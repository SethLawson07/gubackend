...
exports.deleteTypeService = exports.updateTypeService = exports.active = exports.all = exports.addTypeService = void 0;
const zod_1 = require("zod");
const zod_validation_error_1 = require("zod-validation-error");
const server_1 = require("../../server");
function addTypeService(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const savedTypeService = yield server_1.prisma.typeService.create({ data: validation.data });
...
function all(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const all = yield server_1.prisma.typeService.findMany();
...
function active(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const active = yield server_1.prisma.typeService.findMany({ where: { featured: true } });
...
function updateTypeService(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (!validation.success)
                return res.status(400).send({ status: 400, error: true, message: (0, zod_validation_error_1.fromZodError)(validation.error).message, data: {} });
            const savedTypeService = yield server_1.prisma.typeService.update({ where: { id: id, }, data: validation.data, });
            return res.status(200).send({ status: 200, error: false, message: "ok", data: savedTypeService });
        }
        catch (err) {
            return res.status(500).send({ status: 500, error: true, message: "Une erreur s'est produite", data: {} });
...
function deleteTypeService(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            let id = req.params.id;
...
exports.deleteTypeService = deleteTypeService;
