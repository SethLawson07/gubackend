...
import { all_delivery, awaiting_deliveries, deliver, delivered_by_user, delivery_by_user, gain_delivery, receive_delivery, start_delivery } from "../../services/Delivery";
